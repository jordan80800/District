...
<body class="bodysign">
    <div class="container-fluid">
                ...
                <div class="row w-50 center-inputs">
                    <div class="col">
                        <form action="sign_up_script.php" method="POST">
                            <div class="mb-3">
                                <h5><label for="Nom Prénom" class="form-label text-dark">Nom,Prénom</label></h5>
                            ...
                            <div class="mb-3">
                                <h5> <label for="password" class="form-label text-dark">Password</label></h5>
        ...
        <div class="btn d-flex justify-content-center align-items-center btnform">
            <div class="row w-50">
                <div class="col">
                    <input type="submit" class="btn bg-dark text-light m-2" value="S'inscrire" id="confirm" name="confirm">
                </div>
                </form>
            </div>
        </div>
